...
download () {
	get_tar_archive libogg "https://ftp.osuosl.org/pub/xiph/releases/ogg/libogg-${ogg_ver}.tar.xz"
	get_tar_archive libvorbis "https://ftp.osuosl.org/pub/xiph/releases/vorbis/libvorbis-${ogg_ver}.tar.xz"
